...
function loadPlayersPage(){
	...
	for(var i = 0, player; player = players[i]; i++){
		tags += '<a onclick="switchPlayers('+i+')" href="#" class="dropdown-item">'+player.name+'</a>';
	}
...
function switchPlayers(playerNum){
	...
	document.getElementById("avg_p_yards").innerHTML = avg(player.pass_yards, player.games_played);
	document.getElementById("avg_r_yards").innerHTML = avg(player.rushing_yards, player.games_played);
	document.getElementById("avg_rec_yards").innerHTML = avg(player.receiving_yards, player.games_played);
}
function avg(sum, divisor){
	return Math.trunc(sum/divisor);
}
